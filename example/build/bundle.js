...
FirstNestedPanel = React.createClass({
  render: function() {
    return React.createElement("div", {
      "className": "nested-panel-content"
    }, "NestedPanel 1");
  }
});
...
window.addEventListener("load", function() {
  ...
  return React.render(React.createElement(App, null), content);
});
...
Tab = React.createClass({
  ...
  getInitialState: function() {
    ...
    selectedIndex = this.props.factory.getSelectedIndex();
    return {
      selected: selectedIndex === this.props.index
    };
  },
  componentDidMount: function() {
    return this.props.factory.addListener(this._onFactoryUpdate);
...
TabFactory = (function() {
  ...
  TabFactory.prototype.addListener = function(listener) {
    return this._emitter.on(EVENT_NAME, listener);
  };

  TabFactory.prototype.removeListener = function(listener) {
    return this._emitter.removeListener(EVENT_NAME, listener);
  };

  TabFactory.prototype.notify = function() {
    return this._emitter.emit(EVENT_NAME, this._selectedIndex);
  };

  TabFactory.prototype.select = function(index) {
    this._selectedIndex = index;
    return this.notify();
  };

  TabFactory.prototype.getSelectedIndex = function() {
